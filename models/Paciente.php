...
class Paciente extends MySqlConnection implements IMysqlActions{
  ...
  {
    $sql = "INSERT INTO " . self::TABLE_NAME . " (`nombre_paciente`, `apellido_paciente`, `telefono_paciente`, `correo_paciente`, `id_sangre`, `id_departamento`, `id_municipio`, `id_hospital`) VALUES 
    ('" . $this->getNombre_paciente() . "','" . $this->getApellido_paciente() . "','" .$this->getTelefono_paciente()."','".$this->getCorreo_paciente()."',". $this->getId_sangre().",". $this->getId_departamento() . ","  . $this->getId_municipio() . "," . $this->getId_hospital() . ")";
