      ...
      <div class="form-holder">
        ...
        <form action="" class="form">
          <div class="form-group">
            <img src="<?=BASE_DIR?>assets/images/user.png"alt="" />
          ...
          <div class="form-group">
            <img src="<?=BASE_DIR?>assets/images/map.png" alt="" />
              <select name="" id="">
              <option disabled selected>Departameto</option>
          ...
          <div class="form-group">
              <img src="<?=BASE_DIR?>assets/images/gota.png" alt="" />
              <select name="" id="">
